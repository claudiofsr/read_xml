...
impl ProcEventoCte {
    ...
    pub fn get_cte_redespacho_interno(&self) -> Option<String> {
        self
            ...
            .as_ref()
            .and_then(|evento| {
                evento.get_ch_cte_redesp_inter()
            })
    }
    ...
    pub fn get_cte_substituido(&self) -> Option<String> {
        self
            ...
            .as_ref()
            .and_then(|evento| {
                evento.get_ch_cte_substituicao()
            })
    }
