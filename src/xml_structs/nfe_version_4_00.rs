...
impl NfeProc {
    ...
    pub fn get_data_emissao(&self) -> Option<NaiveDate> {
        self
            ...
            .as_ref()
            .and_then(|information| {
                information.ide.get_dt_emissao()
            })
    }
    ...
    pub fn get_total_da_nfe(&self) -> Option<f64> {
        self
            ...
            .as_ref()
            .and_then(|information| {
                information.total.get_valor_nfe()
            })
    }
...
impl Produto {
    pub fn get_descricao(&self) -> Option<String> {
        self
            ...
            .as_ref()
            .map(|descr| {
                descr.trim().replace_multiple_whitespaces().to_uppercase()
            })
    }
    ...
    pub fn get_ncm(&self) -> Option<String> {
        self
            ...
            .as_ref()
            .map(|n| {
                n.remove_non_digits().format_ncm()
            })
    }
    ...
    pub fn get_num_dec_importacao(&self) -> Option<u64> {
        self
            .di
            .as_ref()
            .and_then(|dec_importacao| {
                dec_importacao.get_num_di()
            })
    }
}
